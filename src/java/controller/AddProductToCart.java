...
public class AddProductToCart extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getSession().getAttribute("user") == null) {
            ...
            if (findProdInCart == null) {
                Cart prodToCart = new Cart(1, pid, uid, pname, pimg, pprice, pquantity, pprice * pquantity);
                new CartDAO().insertToCart(prodToCart);
            } else {
            ...
            request.getSession().removeAttribute("cartQuantity");
            request.getSession().setAttribute("cartQuantity", new CartDAO().getAllCart(uid).size());
